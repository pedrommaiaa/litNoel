...
export const makeCountyDesc = (countyName: string) =>
  `Professional Christmas light installation in ${countyName}. Design, install, maintenance, and takedown for homes and businesses. Free quote.`;
...
export const makeCityDesc = (cityName: string, countyName: string) =>
  `Holiday lighting in ${cityName}, ${countyName}. Custom design, professional installation, in‑season maintenance, and hassle‑free removal.`;
